# FPPSP OpenAPI Specification
[![Build Status](https://travis-ci.org/rodrigojv/fp-psp-api-spec.svg?branch=master)](https://travis-ci.org/rodrigojv/fp-psp-api-spec)
...
6. If you did everything correct, https://rodrigojv.github.io/fp-psp-api-spec/ will lead to your new docs
...
- Documentation(ReDoc): https://rodrigojv.github.io/fp-psp-api-spec/
- SwaggerUI: https://rodrigojv.github.io/fp-psp-api-spec/swagger-ui/
- Look full spec:
    + JSON https://rodrigojv.github.io/fp-psp-api-spec/swagger.json
    + YAML https://rodrigojv.github.io/fp-psp-api-spec/swagger.yaml
- Preview spec version for branch `[branch]`: https://rodrigojv.github.io/fp-psp-api-spec/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://rodrigojv.github.io/fp-psp-api-spec/ with url from the message: `Server started <url>`
